...
extern unsigned char utf8charlen[256];
extern unsigned char gbkcharlen[256];
extern unsigned char lowercharmap[256];
extern unsigned char uppercharmap[256];


// 注意c为char则需要转换为unsigned char
