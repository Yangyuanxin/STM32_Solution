...
int hash_create(LPHASHTABLE pht, unsigned int size, hash_func_t hash)
{
  int i;
...
int hash_entry(LPHASHTABLE pht, char *key, unsigned int key_length, void *data)
{
  unsigned long h;
  unsigned int index;
  LPHASHBUCKET p;
...
int hash_find(LPHASHTABLE pht, char *key, unsigned int key_length, void **data)
{
  unsigned long h;
  unsigned int index;
  LPHASHBUCKET p;
...
// 要删除的key不存在返回-1
int hash_remove(LPHASHTABLE pht, char *key, unsigned int key_length)
{
  unsigned long h;
  unsigned int index;
  LPHASHBUCKET p;
...
int hash_update(LPHASHTABLE pht, char *key, unsigned int key_length, void *data)
{
  unsigned long h;
  unsigned int index;
  LPHASHBUCKET p;
